        ...
        if(firstCommand.equals("create new playlist")){
            ...
            for(int i = 0; i < LIMIT; i++){
                ...
                if(command.equals("search by title")){
                    ...
                    for(int j = 0; j < trackList.size() && j < singerList.size(); j++){
                        ...
                        if(func.searchString(trackList.get(j).getTitle(), title)){
                            ...
                            System.out.println(singerList.get(j).toString());

                            System.out.println();

                            System.out.println(trackList.get(j).toString());
                ...
                if(command.equals("sort by title")){
                    ...
                    ArrayList<String> sortedTrackList = new ArrayList<>(func.sortTrackTitle(trackList));
                    
                    System.out.println("Отсортированный плейлист по названиям: ");
                    
                    System.out.println();

                    for (String getSortedTrackList : sortedTrackList) {

                        System.out.println("Псевдоним: " + getSortedTrackList);
                ...
                if(command.equals("sort by duration")){
                    ...
                    ArrayList<Double> sortedTrackList = new ArrayList<>(func.sortTrackDuration(trackList));
                    
                    System.out.println("Отсортированный плейлист по времени: ");
                    
                    System.out.println();

                    for (Double getSortedTrackList : sortedTrackList) {

                        System.out.println("Длительность: " + getSortedTrackList);
                ...
                if(command.equals("sort by genre")){
                    ...
                    ArrayList<String> sortedTrackList = new ArrayList<>(func.sortTrackGenre(trackList));
                ...
                if(command.equals("sort by singer")){
                    ...
                    ArrayList<String> sortedSingerList = new ArrayList<>(func.sortSinger(singerList));
                    
                    System.out.println("Отсортированный плейлист по исполнителям: ");
                    
                    System.out.println();

                    for (String getSortedSingerList : sortedSingerList) {

                        System.out.println("Псевдоним: " + getSortedSingerList);
